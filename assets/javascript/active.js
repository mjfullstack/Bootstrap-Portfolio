...
$(document).ready(function(){
    ...
    },
    {
        ...
        contrib : "Sole Contributor HW",
        shortDesc : "Beginning javascript project",
...
var showPortfolioJQuery = function (item) { // (destCol, itemTitleNum, itemTitleStr, itemURL, imageHTML, catIDin, regIDin) {
    ...
    // Title
    var appRepoText = "<h5 id='repo-link'><a href='" + appRepo + "'>" + appDesc + "</a>Repo: </h5>";
    var appDeployText = "<h5 id='app-link'><a href='" + appDeploy + "'>" + appName + "</a>Deployed: </h5>";
